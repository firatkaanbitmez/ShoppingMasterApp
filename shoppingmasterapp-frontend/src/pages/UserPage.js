...
import '../assets/styles.css'; // Genel stiller
import '../assets/layout.css'; // Layout ve sayfa düzeni
import '../assets/header.css'; // Header stilleri
import '../assets/footer.css'; // Footer stilleri
import '../assets/UserPage.css'; // UserPage stilleri
